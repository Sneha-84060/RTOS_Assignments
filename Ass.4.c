...
int main() {
    ...
    const int n = 3;
    struct sigaction sa;
    int priorities[3] = {30, 20, 10}; // Priorities for the child processes
...
// Compile with: gcc -pthread -o priority_tasks priority_tasks.c
// Run with sudo to set FIFO scheduling: sudo ./priority_tasks
